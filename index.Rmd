...
## Bio
With a core foundation knowledge in earth science and specialised in Geospatial Analysis, Charlie is able to integrate available technologies of UAVs, satellite imagery, programming languages and GI systems into any field that requires location- based analytics. He also enjoys working in a team and can also work independently with minimal supervision. In addition to that, He's a keen learner and is always in pursuit of knowledge and skills with attention to detail. Knowledge of Python and R programming complements spatial data analysis skills in geospatial data wrangling.
